...
import { GOLD, AERIAL_IMG, SERIF, RR_LOGO } from "./constants";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.30) 0%, rgba(0,0,0,0.52) 50%, rgba(0,0,0,0.88) 100%)",
          }}
        />
      </div>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 max-w-md mx-auto">
          {[
            ...
            <div key={i} className="text-center">
              <div className="text-2xl md:text-3xl font-bold" style={{ color: GOLD }}>{s.val}</div>
